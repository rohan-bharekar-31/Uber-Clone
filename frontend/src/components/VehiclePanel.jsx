...
const VehiclePanel = ({ setvehiclePanelOpen,setConfirmRidePanelOpen,fare,setVehicleType }) => {
    ...
    return (
        <>
            ...
            <div onClick={()=>{setConfirmRidePanelOpen(true),setvehiclePanelOpen(false),setVehicleType("car")}} className='flex items-center justify-between mb-2  border-2 active:border-black rounded-lg p-3  bg-white w-full gap-x-1'>
                ...
                <h2 className='text-xl w-1/2 font-semibold text-center'>$ {fare.car}</h2>
            </div>


            <div onClick={()=>{setConfirmRidePanelOpen(true),setvehiclePanelOpen(false),setVehicleType("auto")}} className='flex items-center bg-gray-100 active:border-black justify-between mb-2  border-2 rounded-lg p-3  bg-white w-full gap-x-1'>
                ...
                <h2 className='text-xl w-1/2 font-semibold text-center'>$ {fare.auto}</h2>
            </div>


            <div onClick={()=>{setConfirmRidePanelOpen(true),setvehiclePanelOpen(false),setVehicleType("bike")}}  className='flex items-center justify-between mb-2  border-2 active:border-black rounded-lg p-3  bg-white w-full gap-x-1'>
                ...
                <h2 className='text-xl w-1/2 font-semibold text-center'>$ {fare.bike}</h2>
            </div>
        </>
    )
}
